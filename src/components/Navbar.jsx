...
import Store from './navcom/Store';
            ...
            <div className='bg-white w-full  mb-10'>
                <div className='flex justify-center p-3'>
                    <ul className='flex justify-center gap-10 [&>*]:text-[13px] [&>*]:text-gray-800'>
                        ...
                        <Link to='/store'><li onMouseOver={()=>{setIsOpen(true);}} onMouseLeave={()=>{setIsOpen(false);}}>Store</li></Link>
                        ...
                        <Link to='/tv&home'><li>TV & Home</li></Link>
